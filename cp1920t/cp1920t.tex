...
\\
\>[B]{}\Varid{discollect}\mathrel{=}\Varid{lstr}\mathbin{.!}\Varid{id}{}\<[E]%
\\[\blanklineskip]%
...
\column{25}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{auxMaisDir}\mathbin{::}(\Varid{a},(\Conid{Maybe}\;\Varid{a},\Conid{Maybe}\;\Varid{a}))\to \Conid{Maybe}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{auxMaisDir}\;(\Varid{h},(\Varid{l},\Conid{Nothing}))\mathrel{=}\Conid{Just}\;\Varid{h}{}\<[E]%
\\
\>[B]{}\Varid{auxMaisDir}\;(\anonymous ,(\anonymous ,\Varid{r}))\mathrel{=}\Varid{r}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{maisDir}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{auxMaisDir}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxMaisEsq}\mathbin{::}(\Varid{a},(\Conid{Maybe}\;\Varid{a},\Conid{Maybe}\;\Varid{a}))\to \Conid{Maybe}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{auxMaisEsq}\;(\Varid{h},(\Conid{Nothing},\Varid{r}))\mathrel{=}\Conid{Just}\;\Varid{h}{}\<[E]%
\\
\>[B]{}\Varid{auxMaisEsq}\;(\anonymous ,(\Varid{l},\anonymous ))\mathrel{=}\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{maisEsq}\mathrel{=}\Varid{cataBTree}\;\Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Nothing}}}{\Varid{auxMaisEsq}}{}\<[E]%
\\[\blanklineskip]%
...
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxisOrd}\mathbin{::}(\Conid{Ord}\;\Varid{a})\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{auxisOrd}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{auxisOrd}\;\Varid{l}\mid \Varid{l}\equiv \Varid{qSort}\;(\Varid{l})\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\hsindent{12}{}\<[12]%
\>[12]{}\mid \Varid{l}\not\equiv \Varid{qSort}\;(\Varid{l})\mathrel{=}\Conid{False}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isOrd}\mathrel{=}\Varid{auxisOrd}\comp \Varid{inordt}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxRRot}\mathbin{::}(\Varid{a},(\fun{BTree} \;\Varid{a},\fun{BTree} \;\Varid{a}))\to \fun{BTree} \;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{auxRRot}\;(\Varid{h},(\Conid{Empty},\Varid{r}))\mathrel{=}\Conid{Node}\;(\Varid{h},(\Conid{Empty},\Varid{r})){}\<[E]%
\\
\>[B]{}\Varid{auxRRot}\;(\Varid{h},((\Conid{Node}\;(\Varid{l},(\Varid{ll},\Varid{lr}))),\Varid{r}))\mathrel{=}\Conid{Node}\;(\Varid{l},(\Varid{ll},\Conid{Node}\;(\Varid{h},(\Varid{lr},\Varid{r})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rrot}\mathrel{=}{}\<[9]%
\>[9]{}\Varid{g}\comp \Varid{outBTree}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Empty}}}{\Varid{auxRRot}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxLRot}\mathbin{::}(\Varid{a},(\fun{BTree} \;\Varid{a},\fun{BTree} \;\Varid{a}))\to \fun{BTree} \;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{auxLRot}\;(\Varid{h},(\Varid{l},\Conid{Empty}))\mathrel{=}\Conid{Node}\;(\Varid{h},(\Varid{l},\Conid{Empty})){}\<[E]%
\\
\>[B]{}\Varid{auxLRot}\;(\Varid{h},(\Varid{l},(\Conid{Node}\;(\Varid{r},(\Varid{rl},\Varid{rr})))))\mathrel{=}\Conid{Node}\;(\Varid{r},((\Conid{Node}\;(\Varid{h},(\Varid{rl},\Varid{l}))),\Varid{rr})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lrot}\mathrel{=}\Varid{g}\comp \Varid{outBTree}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{g}\mathrel{=}\alt{\underline{\Conid{Empty}}}{\Varid{auxLRot}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{splay}\;\Varid{l}\;\Varid{t}\mathrel{=}(\Varid{flip}\;\Varid{cataBTree}\;\Varid{t}\;\Varid{g})\;\Varid{l}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;((\Varid{a},(\Varid{l},\Varid{r})),\Varid{t})\mid \Varid{head}\;\Varid{t}\equiv \Conid{True}\mathrel{=}\Varid{rrot}\;(\Conid{Node}\;(\Varid{a},(\Varid{l}\;(\Varid{tail}\;\Varid{t}),\Varid{r}\;[\mskip1.5mu \mskip1.5mu]))){}\<[E]%
\\
\>[9]{}\hsindent{16}{}\<[25]%
\>[25]{}\mid \Varid{otherwise}\mathrel{=}\Varid{lrot}\;(\Conid{Node}\;(\Varid{a},(\Varid{l}\;[\mskip1.5mu \mskip1.5mu],\Varid{r}\;(\Varid{tail}\;\Varid{t})))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{outBdt}\;(\Conid{Dec}\;\Varid{x}){}\<[27]%
\>[27]{}\mathrel{=}i_1\;(\Varid{x}){}\<[E]%
\\
\>[B]{}\Varid{outBdt}\;(\Conid{Query}\;(\Varid{s},(\Varid{t1},\Varid{t2})))\mathrel{=}i_2\;(\Varid{s},(\Varid{t1},\Varid{t2})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseBdt}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{id}+(\Varid{f}\times(\Varid{g}\times\Varid{g})){}\<[E]%
\\
\>[B]{}\Varid{recBdt}\;\Varid{g}{}\<[13]%
\>[13]{}\mathrel{=}\Varid{baseBdt}\;\Varid{id}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[9]{}\hsindent{16}{}\<[25]%
\>[25]{}\mid \Varid{otherwise}\mathrel{=}\Varid{r}\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
     \ensuremath{\mathit B\;(\mathit B,\Conid{A})}
              \ar[u]_-{\ensuremath{\mathit B\;(\Varid{id},\Varid{anaBdt})}}
}
\end{eqnarray*}
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;((\Varid{l1},\Varid{r1}),\Conid{Empty})\mathrel{=}\Conid{Fork}\;(\Varid{l1}\;\Conid{Empty},\Varid{r1}\;\Conid{Empty}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;((\Varid{l1},\Varid{r1}),(\Conid{Node}\;(\Varid{a},(\Conid{Empty},\Varid{r2})))){}\<[45]%
\>[45]{}\mid \Varid{a}\equiv \Conid{True}\mathrel{=}\Varid{l1}\;\Conid{Empty}{}\<[E]%
\\
\>[45]{}\mid \Varid{otherwise}\mathrel{=}\Varid{r1}\;\Varid{r2}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{k}\;((\Varid{l1},\Varid{r1}),(\Conid{Node}\;(\Varid{a},(\Varid{l2},\Conid{Empty})))){}\<[45]%
\>[45]{}\mid \Varid{a}\equiv \Conid{True}\mathrel{=}\Varid{l1}\;\Varid{l2}{}\<[E]%
\\
\>[45]{}\mid \Varid{otherwise}\mathrel{=}\Varid{r1}\;\Conid{Empty}{}\<[E]%
\\[\blanklineskip]%
